...
if(isset($_GET['pg'])){
  ...
  if($_GET['pg']=="mk"){
    ...
    if(isset($_GET['sp'])){
      if($_GET['sp']=="baru"){
          $titlepage = "Tambah Data Matakuliah";
          $pg = "mk-addnew.php"; 
      }
      if($_GET["sp"]=="edit"){
          $titlepage = "Edit Data Matakuliah";
          $pg = "mk-editdata.php"; 
      }
      if($_GET["sp"]=="dele"){
          $titlepage = "Hapus Data Matakuliah";
          $pg = "mk-deledata.php"; 
      }
    }
  }
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="index.php?pg=mk">Data Matakuliah</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="index.php?pg=ds">Data Dosen</a>
        </li>
      </ul>
    </div>
  </div>
